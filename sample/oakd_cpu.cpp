...
int main() {
    ...
    while (true) {
        ...
        // The CPU ELAS takes grayscale images as input
        elas.process(leftMat.data, rightMat.data,
                     disparityLeft.data(), disparityRight.data());
        ...
        cv::imshow("Disparity (CPU)", displayDisp);
